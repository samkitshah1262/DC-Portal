...
# from dcportal.settings import config
import dcportal.settings as settings
import requests
...
def teacher_required(view_func=None, login_url='/login', message=default_message):
    """
    Decorator for views that checks that the user is logged in and is a
    superuser, displaying message if provided.
    """
    actual_decorator = user_passes_test(
        lambda u: u.is_active and user_type.is_teach and u.is_authenticated,
        login_url=login_url,
